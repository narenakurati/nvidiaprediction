...
d1 <- ggplot(df1, aes(x = card, y = transistor.density)) + geom_bar(stat = "identity", fill = c("#203300", "#76b900")) + guides(fill=FALSE) + labs(y = "transistor density")
d2 <- ggplot(df1, aes(x = card, y = TFLOPs)) + geom_bar(stat = "identity", fill = c("#203300", "#76b900"))  + guides(fill=FALSE)
d3 <- ggplot(df1, aes(x = card, y = X1080p.performance)) + geom_bar(stat = "identity", fill = c("#203300", "#76b900"))  + guides(fill=FALSE) + labs(y = "gaming performance")
