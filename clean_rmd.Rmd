...
kable(data.frame("card" = xx80[,1], "transistor_denisty" = scaled_transistor_density)) %>%  kable_styling(bootstrap_options = c("striped", "hover", "condensed")) %>% save_kable(file = "cards_transistor_density.html")
```
...
kable(data.frame("date" = moore_dates, "transistor_denisty" = moore_predicted_scaled_transistory_density))
