...
p1 <- ggplot(xx80, aes(x = as.Date(launch), y = processing_power_single)) + geom_point() + geom_smooth(se=FALSE, color = "#619CFF") + labs(x = "time", y = "floating point performance") + ggtitle("Floating Point Perf. over Time")
...
summary(threedmark_model)$r.squared
